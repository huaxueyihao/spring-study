...
create table sys_plan (
        ...
        min_total_plan_amount INTEGER(10) comment  '计划量:比如，书籍多少页，视频多少集，可进行量化的量或者某个计划分了1，2，3，4个阶段，共4阶段，完成到几阶段',
        max_total_plan_amount INTEGER(10) comment  '计划量:比如，书籍多少页，视频多少集，可进行量化的量或者某个计划分了1，2，3，4个阶段，共4阶段，完成到几阶段',
